    ...
    <section className="space-y-4">
      ...
      <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
        {groups.map((g) => (
          <div
            key={g.group}
            className="border-border/60 card-glass min-w-0 overflow-hidden rounded-xl border"
          >
...
async function TopScorersSection() {
  ...
  return (
    <section className="space-y-4">
      ...
      <div className="border-border/60 card-glass overflow-hidden rounded-xl border">
